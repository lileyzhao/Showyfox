...
/// 全局规范化结果
/// </summary>
[UnifyModel(typeof(SfxResult<>))]
public class SfxUnifyResultProvider : IUnifyResultProvider
{
    /// <summary>
    /// 异常返回值
    /// </summary>
    ...
    /// <returns></returns>
    private static SfxResult<object> RESTfulResult(int statusCode, bool succeeded = default, object? data = default, object? errors = default)
    {
        //// 统一返回值脱敏处理
