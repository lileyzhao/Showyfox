...
/// <summary>
/// 含数据范围的基础实体抽象类，
/// 继承 <see cref="EntityBase"/> 并增加了 <see cref="CreateOrgId"/>、<see cref="CreateOrgName"/> 字段定义
/// </summary>
public abstract class EntityScope : EntityBase, IEntityFieldScope, IScopeFilter
{
